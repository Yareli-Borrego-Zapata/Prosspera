...
def RecoveryView(page: ft.Page, auth_controller):
    ...
    paso_correo = ft.Column(
        ...
        spacing=14,
        controls=[
            ft.Text("RECUPERAR CUENTA", size=24, weight="bold", color=ft.Colors.CYAN_100),
            ft.Text("Introduce tu correo para validar tu identidad", size=13, color=ft.Colors.WHITE54),
    ...
    paso_restablecer = ft.Column(
        ...
        visible=False,
        controls=[
            ft.Text("NUEVA CONTRASEÑA", size=24, weight="bold", color=ft.Colors.CYAN_100),
            ft.Text("Introduce el código enviado y tu nueva clave", size=13, color=ft.Colors.WHITE54),
            ft.Container(height=4),
            token_input,
            nueva_pass,
            confirmar_pass,
                ...
                content=ft.Column(
                    ...
                    controls=[
                        ft.Container(
                            ...
                            content=ft.Icon(ft.Icons.LOCK_RESET_ROUNDED, size=34, color=ft.Colors.CYAN_300),
